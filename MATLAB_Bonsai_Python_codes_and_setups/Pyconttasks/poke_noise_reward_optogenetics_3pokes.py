...
poke2  = Poke(board.port_4, rising_event='poke2', falling_event='poke2_out', debounce=5)
poke3  = Poke(board.port_5, rising_event='poke3', falling_event='poke3_out', debounce=5)
...
optogenetic = Digital_input(pin=board.BNC_1, rising_event='opto_on', falling_event='opto_off', debounce=1000)
...
events = ['poke', 'poke_out','lick_detect','lick_off','sound_off','opto_on','opto_off','poke2', 'poke2_out','poke3', 'poke3_out','movie_onset','session_timer']
