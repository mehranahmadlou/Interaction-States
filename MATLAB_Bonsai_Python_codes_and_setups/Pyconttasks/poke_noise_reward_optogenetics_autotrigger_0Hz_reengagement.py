...
optogenetic = Digital_output(pin=board.BNC_1, inverted=False, pulse_enabled=False)
...
events = ['poke', 'poke_out','lick_detect','lick_off','sound_off','session_timer','OptoOn','movie_onset']
