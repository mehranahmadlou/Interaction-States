...
laser = 5
opto_pulse_duration = 4.7
opto_repeat = 24
ISI = 0.3
prestimulus = 0
after_opto = 120
movie_duration = (opto_pulse_duration + ISI) * opto_repeat + prestimulus + after_opto
movie_directory = '/home/pi/swc/mrsic_flogel/public/projects/MeAhetal_20210211_Optogenetics_Behavior/TMT_object/11257xx/Opto_TMT_2.h264'
projection = 'SERT MRN ChR2'
